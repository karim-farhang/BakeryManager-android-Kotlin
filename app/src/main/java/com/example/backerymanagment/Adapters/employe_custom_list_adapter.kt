...
import com.example.backerymanagment.employeUpdateActivity

class employe_custom_list_adapter(private val myContext: Context, private val customListItem: ArrayList<employe_custom_list>) : ArrayAdapter<employe_custom_list>(myContext, 0, customListItem) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (listLayout == null) {
            ...
            listLayout = inflaterList.inflate(R.layout.employe_custome_list_view, parent, false)

            holder = ViewHolder()
            holder.txtName = listLayout!!.findViewById(R.id.employeCustomList_name)
            holder.txtAddress = listLayout.findViewById(R.id.employeCustomList_address)
            holder.txtPhone = listLayout.findViewById(R.id.employeCustomList_phone)
            holder.txtDate= listLayout.findViewById(R.id.employeCustomList_date)
            holder.txtPosition = listLayout.findViewById(R.id.employeCustomList_Postiton)
            holder.txtSalary = listLayout.findViewById(R.id.employeCustomList_salary)
            holder.txtDescription = listLayout.findViewById(R.id.employeCustomList_description)
            holder.btnDelete = listLayout.findViewById(R.id.employe_btn_delete)
            holder.btnUpdate = listLayout.findViewById(R.id.employeCustomList_btnUpdate)
        ...
        holder.txtPosition!!.setText(listItem.position)
        holder.txtSalary!!.setText(listItem.salary)
        ...
        holder.btnDelete!!.setOnClickListener {
            ...
            alert.setPositiveButton("بله") { _, _ ->
                ...
                val result: Boolean = db.deleteEmployee(listItem.id.toString())
                when {
                    result -> {
        ...
        holder.btnUpdate!!.setOnClickListener {
            ...
            band.putString("pos",listItem.position)
            band.putString("salary",listItem.salary)
            band.putString("desc",listItem.description)

            val intent = Intent(myContext, employeUpdateActivity::class.java)
    ...
    class ViewHolder {
        ...
        internal var txtPosition:TextView? = null
        internal var txtSalary :TextView?= null
